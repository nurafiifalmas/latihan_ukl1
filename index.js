...
app.post('/laptop', isAuthorized, (request, result) => {
    data = request.body

    data.forEach(element => {
        
        db.query(`
        insert into laptop (jenis_barang, type, warna, spesifikasi, harga, stock, keterangan)
...
// endpoint untuk mengubah data user
app.put('/laptop/:id', isAuthorized, (request, result) => {
    let data = request.body
